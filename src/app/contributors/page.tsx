  ...
  return (
    <main className="mx-auto max-w-[68rem] px-6 lg:px-8 py-12">
      ...
      <p className="mb-8 text-sm text-muted-foreground">
        People who help keep Forklane accurate
      </p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-muted/50">
                ...
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Contributor</th>
                <th className="px-4 py-3 text-right font-medium text-muted-foreground">Reputation</th>
                <th className="px-4 py-3 text-right font-medium text-muted-foreground">Edits</th>
