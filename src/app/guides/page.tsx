...
export const metadata: Metadata = {
  title: 'Guides — Forklane',
  description: 'In-depth guides on migrating to open-source alternatives.',
...
export default async function GuidesIndexPage() {
  ...
  return (
    <main className="mx-auto max-w-[68rem] px-6 lg:px-8 py-12">
      ...
      <h1 className="mb-8 text-3xl font-bold tracking-tight">Guides</h1>
