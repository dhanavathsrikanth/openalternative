...
const CATEGORY_STYLES: Record<string, { bg: string; icon: React.ReactNode }> = {
  ...
  'ui-libraries': {
    bg: 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300',
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  caching: {
    bg: 'bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-300',
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  'static-sites': {
    bg: 'bg-lime-100 text-lime-700 dark:bg-lime-900 dark:text-lime-300',
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CategoryIcon({ categorySlug, className }: CategoryIconProps) {
  const key = categorySlug.toLowerCase().replace(/\s+/g, '-')
